...
@section('content')
    <div style="float: right;margin: 20px 0px 5px 0;">
        <a href="{{route('single-post.create')}}" class="btn btn-success"> Single Post Create
        </a>
    </div>
    ...
    <div class="widget-box">
        <div class="widget-title"><span class="icon"><i class="icon-th"></i></span>
            <h5>Single Post Table</h5>
        </div>
        <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
                <thead>
                <tr>
                    <th>Turkish Single Menu Name</th>
                    <th>Turkish Title</th>
                ...
                @foreach($singlePost as $post)
                    <tr class="gradeX">
                        ...
                        <td class="center"><a href="{{route('single-post.edit',$post->id)}}"
                                              class="btn btn-success btn-mini">Edit</a>
                        </td>
                        {!! Form::model($singlePost,['route'=>['single-post.destroy',$post->id],'method'=>'DELETE']) !!}
                        <td class="center">
