            ...
            <div class="widget-box">
                ...
                <div class="widget-content nopadding">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <textarea name="description_tr" id="description_tr-ckeditor" >{{old('description_tr')}}</textarea>
                        </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <textarea name="description_eng" id="description_eng-ckeditor" >{{old('description_eng')}}</textarea>
                        </div>
...
@section('js')
    ...
    <script>
        CKEDITOR.replace( 'description_eng-ckeditor' );
    </script>
